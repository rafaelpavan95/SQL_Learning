-- criar um database
CREATE DATABASE db_Univerisdade;

-- utilizar o database
USE db_Universidade;

-- cria tabelas
CREATE TABLE Departamento(Cod_Departamento INT PRIMARY KEY AUTO_INCREMENT, Nome_Departamento VARCHAR(20) NOT NULL);

CREATE TABLE Professor(Cod_Professor INT PRIMARY KEY AUTO_INCREMENT,
...
CREATE TABLE Turma (Cod_Turma INT PRIMARY KEY NOT NULL,
					Cod_Curso INT,
					Periodo VARCHAR(20),
                    Num_Aluno INT,
                    Data_Inicio DATE,
...
CREATE TABLE Disciplina (Cod_Disciplina INT PRIMARY KEY AUTO_INCREMENT,
...
CREATE TABLE Prof_Disciplina (Cod_Professor INT PRIMARY KEY NOT NULL,
...
CREATE TABLE Tipo_Telefone(Cod_Tipo_Telefone INT PRIMARY KEY AUTO_INCREMENT,Tipo_Telefone VARCHAR(8));

CREATE TABLE Telefones_Aluno (Cod_Telefones_Aluno INT PRIMARY KEY AUTO_INCREMENT,
							 RA INT NOT NULL,
...
CREATE TABLE Tipo_Logradouro ( Cod_Tipo_Logradouro INT PRIMARY KEY AUTO_INCREMENT, Tipo_Logradouro VARCHAR(11));

CREATE TABLE Endereco_Aluno ( Cod_Endereco_Aluno INT PRIMARY KEY AUTO_INCREMENT,
							 RA INT NOT NULL,
