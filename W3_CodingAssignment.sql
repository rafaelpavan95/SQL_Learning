...
SELECT Artists.Name, Artists.ArtistId, Albums.Title AS Album FROM Artists 
...
UNION SELECT FirstName, LastName FROM Customers
ORDER BY LastName DESC;


--7. See if there are any customers who have a different city listed in their billing city versus their customer city.

SELECT C.FirstName, C.LastName, C.City, I.BillingCity FROM Customers C
